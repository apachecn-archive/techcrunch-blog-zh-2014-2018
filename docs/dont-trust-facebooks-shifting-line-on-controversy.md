...
扎克伯格没有为管理有争议的内容提出一个工程解决方案，这难道不奇怪吗？比如，他一直如此专注于寻求假新闻问题的工程解决方案。他为什么不谈谈人工智能如何在不冒犯他人的情况下，应对弄清个人内容品味的复杂挑战？
 ...
 *换句话说，脸书可以转移对其算法分流到全球用户新闻订阅源的内容类型的反对意见，作为一个“设置配置”问题——回避必须解决脸书产品设计中更系统和更根本的缺陷:即过滤气泡问题。
