...
“图灵测试已经成为测试你的人工智能软件是否优秀的风向标，基于你是否能把它与人类区分开来，”这是金对谷歌为什么可能选择类似的技巧作为 Duplex 的实验展示的建议。
...
该标准还敦促“澄清是否有意模拟人类，或有意或预期的行为”。所以，再一次，不要试图把你的机器人伪装成人类；你需要弄清楚这是一个机器人。
