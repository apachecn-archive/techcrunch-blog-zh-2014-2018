# 随着脸书追逐隐私，Instagram 突然扼杀了开发者——第 49 页

> 原文：<https://web.archive.org/web/https://techcrunch.com/2018/04/02/instagram-api-limit/49/>
...
但至少开发商得到了关于 7 月 31 日最后期限的公正警告。继 T2 事件后，为了加强数据隐私保护，脸书政府在上周一暂停了对新申请的审查，这让问题变得更加严重。Instagram 向 TechCrunch 证实，暂停应用程序提交的措施已经延伸到了 Instagram 的新 API，但 insta gram 对 API 限制未做任何解释。因此 Instagram 打破了旧的应用程序，同时不允许开发者提交新的、符合标准的应用程序。

![](img/7c62e73cadecbcd0ffce89e0f7bb23fe.png)

一位要求不透露姓名的开发者告诉我:“Instagram 缺乏沟通让我很沮丧，因为现在我要忙着更新应用程序，还要处理大量不满意的客户。”“如果我有一个月的时间做准备，我本可以调整一下策略，让自己更难达到这样的极限。我会对自己的要求更为节俭。突然之间，我在 Instagram 上收到了几十封电子邮件和 DMs，都说这个应用程序不起作用。”

虽然脸书通过获取大量用户数据来审查应用程序是明智之举，但脸书这样做时并未发出任何警告，甚至没有发布任何公告，这就是它在 2009 年左右伤害与开发者关系的方式，当时它试图迅速控制垃圾邮件的猖獗程度。脸书正在经历一场“T4”良心危机，它的应用程序是否会被那些试图干涉选举或仅仅利用我们的数据获取利润的人滥用为武器。
